# LocalKey Browser Extension

This directory contains the companion Manifest V3 browser extension for LocalKey. It allows LocalKey to bridge the gap between your desktop application and your web browser seamlessly.
...
3. **The Service Worker (`background.js`)**: Receives the bridged data and forwards it to the LocalKey Python Native Messaging Host on your desktop for cryptographic signing.
...
## Connecting to LocalKey

For this extension to work, your browser needs to know how to communicate with the LocalKey Python app.

1. Take the **Extension ID** you copied (Firefox users skip this step).
2. Open the **LocalKey Application** and log into your vault.
3. On the sidebar, click the **"Browser Integrations"** button.
4. Paste your Extension ID into the box and click **Install**.

The application will handle all the complex cross-platform setup for you, including standard directories and Flatpak sandbox configurations. Once completed, anytime a website asks for a Passkey, this extension will securely forward the request directly to your LocalKey application!
